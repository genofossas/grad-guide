...
I don’t expect that this document will be useful to everyone, but I hope to provide some use to those that may be in the same boat. Applying to graduate school stressed me out, and I wish I had more opinions to read and compare. Especially opinions of people that had a mediocre GPA when applying, like myself. This document is going to be an amalgamation of things I've heard from my undergraduate mentor and things I've learned in helpful documents. Everything that isn't from my mentor will be properly cited.
...
So, you've finally submitted your applications and are waiting anxiously. The next step to look out for is a professor reaching out (usually by email) to request an interview with you. Not all accepted students are interviewed, as conducting interviews is professor and school dependent, but it's important to keep an eye on the email you used to apply anyway.
